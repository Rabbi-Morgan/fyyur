...
Revision ID: 483204594be0
Revises: 972584c20429
Create Date: 2022-06-09 19:29:58.016423
...
revision = '483204594be0'
down_revision = '972584c20429'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('Venue', 'website_link',
               existing_type=sa.VARCHAR(length=120),
               nullable=False)
    op.alter_column('Venue', 'seeking_decription',
               existing_type=sa.VARCHAR(length=500),
               nullable=False)
